...
const Form = ({handleSubmit}) => {
  ...
  return (
    <div className='flex flex-col p-5 h-48 w-96 rounded-xl bg-white shadow-2xl justify-center items-center'>
      <input onChange={(e) => handleInputChange(e)} onKeyPress={(e) => handleKeyPress(e)} value={name} className='outline-none h-12 text-xl border-2 rounded-lg font-mono' type='text' placeholder='Enter Name'/>
